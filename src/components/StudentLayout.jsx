...
import { FiBell, FiHome, FiBriefcase, FiList, FiInfo, FiUsers, FiFileText, FiBarChart2, FiCalendar, FiPhone as FiPhoneIcon, FiTool, FiUser } from "react-icons/fi";
import '../CSS/SCADOfficeDashboard.css';
import { Link } from "react-router-dom";

const navItems = [
    { label: "Home", icon: <FiHome />, link: "/Studentdashboard" },
    ...
    return (
        ...
        >
            <aside className="sidebar" aria-label="Sidebar Navigation">
                <div className="sidebar-brand">Student</div>
                <nav>
