...
const PROStudentNotifications = () => {
    ...
    const notifications = [
        ...
        { id: 5, message: "Ahmed Ali accepted your appointment at 10:00 AM on 12-May-2025.", date: "2025-05-12" },
        { id: 6, message: "Sara Mohamed rescheduled your appointment to 2:30 PM on 13-May-2025.", date: "2025-05-13" },
        { id: 7, message: "📅 Reminder: You registered for the 'Real-World Skills Workshop' on the 25th.", date: "2025-05-16" },
        { id: 8, message: "📣 The 'Career Development Workshop' starts tomorrow at 10:00 AM. Good luck!", date: "2025-05-17" }
    ];
        ...
        <div style={{
            ...
            <main style={{ padding: '30px 40px', flex: 1 }}>
                <button
                    ...
                    onClick={() => window.location.href = "/PROStudentDashboard"}
                >
                    ← Back to Dashboard
                </button>
